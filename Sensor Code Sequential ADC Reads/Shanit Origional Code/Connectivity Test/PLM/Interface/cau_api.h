/*
 * CAU Header File
 *  Works with library cau_lib.a and mmcau_lib.a
 *  Define FREESCALE_CAU if CAU coprocessor is used --Register parameter passing is assumed
 *  Define FREESCALE_MMCAU if mmCAU coprocessor is used --EABI for Kinetis ARM Cortex-M4
 *  08/26/2011
 */

#define FREESCALE_MMCAU TRUE
...
//
//   return
//           0           no error -> CAU2 hardware present: no SHA256 HW support
//           -1          error -> no CAU2 hardware present: no SHA256 HW support
//
//   calling convention
