...
{
  /* Set the LPLLSM field to 0b110 for VLLS1 mode */
#if (MCU_MK60N512VMD100 == 1)
  MC_PMCTRL = (MC_PMCTRL & (MC_PMCTRL_RUNM_MASK | MC_PMCTRL_LPWUI_MASK)) |
 ...
 * Description: Puts the processor into VLLS0 (Very Low Leakage Stop0).
...
{
  /* Set the LPLLSM field to 0b110 for VLLS0 mode */
#if (MCU_MK60N512VMD100 == 1)
  MC_PMCTRL = (MC_PMCTRL & (MC_PMCTRL_RUNM_MASK | MC_PMCTRL_LPWUI_MASK)) |
               MC_PMCTRL_LPLLSM(0x8) ;
#elif ((MCU_MK60D10 == 1)  || (MCU_MK21DN512 == 1) || (MCU_MK21DX256 == 1))
  SMC_PMCTRL = (SMC_PMCTRL & (SMC_PMCTRL_RUNM_MASK | SMC_PMCTRL_LPWUI_MASK)) |
               SMC_PMCTRL_STOPM(0x4) ;
  SMC_VLLSCTRL = SMC_VLLSCTRL_VLLSM(0x0) ;
#endif
  
  /* Set the SLEEPDEEP bit to enable CORTEX M4 deep sleep mode */
  SCB_SCR |=( SCB_SCR_SLEEPDEEP_MASK | 0x20 );	
...
)
{
  ...
  {
    PORTC_PCR4 |= PORT_PCR_ISF_MASK; //PTC4 
