...
static volatile bool_t mPWRLib_RTC_IsOscStarted = 0;
...
)
{
  ...
  ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) = (((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) & (0x60u | 0x80u)) |
               (((uint8_t)(((uint8_t)(0x0))<<0))&0x7u) ;
...
)
{
  ...
  ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) = (((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) & (0x60u | 0x80u)) |
               (((uint8_t)(((uint8_t)(0x4))<<0))&0x7u) ;
  ((((SMC_MemMapPtr)0x4007E000u))->VLLSCTRL) = (((uint8_t)(((uint8_t)(0x3))<<0))&0x7u);
...
)
{
  ...
  ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) = (((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) & (0x60u | 0x80u)) |
               (((uint8_t)(((uint8_t)(0x4))<<0))&0x7u) ;
  ((((SMC_MemMapPtr)0x4007E000u))->VLLSCTRL) = ((((uint8_t)(((uint8_t)(0x2))<<0))&0x7u) | 0 );
...
)
{
  ...
  ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) = (((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) & (0x60u | 0x80u)) |
               (((uint8_t)(((uint8_t)(0x4))<<0))&0x7u) ;
  ((((SMC_MemMapPtr)0x4007E000u))->VLLSCTRL) = (((uint8_t)(((uint8_t)(0x1))<<0))&0x7u);
...
)
{
  ...
  ((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) = (((((SMC_MemMapPtr)0x4007E000u))->PMCTRL) & (0x60u | 0x80u)) |
               (((uint8_t)(((uint8_t)(0x4))<<0))&0x7u) ;
  ((((SMC_MemMapPtr)0x4007E000u))->VLLSCTRL) = (((uint8_t)(((uint8_t)(0x0))<<0))&0x7u) ;
  
   
  ((((SCB_MemMapPtr)0xE000E000u))->SCR) |=( 0x4u | 0x20 );	
...
)
{
  ...
  pwrModesReg = MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x3D);
   
  pwrModesReg &= (uint8_t) ~( (1<<1) | (1<<0) );
   
  if( (pwrModesReg & (1<<4) ) != (1<<4) )
  {
     
    pwrModesReg |= (uint8_t) (1<<4);
    MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x3D, pwrModesReg);
     
    while( ( MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x3D) & (1<<5) ) != (1<<5));
     
    while( ( MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x01) & ((1<<0) | (1<<3)) ) != ((1<<0) | (1<<3)) );
    MC1324xDrv_DirectAccessSPIWrite((uint8_t) 0x01, (uint8_t) ((1<<0)));
  }
  else
  {
     
    phyCtrl1Reg = MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x03 );
    if( (phyCtrl1Reg & (7<<0)) != 0x00 )
    {
       
       
      if( ( 0 != ( MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x03) & (7<<0) ) ) && ((MC1324xDrv_DirectAccessSPIRead(0x24)&0x1F) != 0))
      {
        phyCtrl1Reg &= (uint8_t) ~((7<<0));
        MC1324xDrv_DirectAccessSPIWrite(0x03, phyCtrl1Reg);
        while ((MC1324xDrv_DirectAccessSPIRead(0x24) & 0x1F) != 0);
      }
        
      irqSts1Reg = MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x00);
      irqSts1Reg |= (uint8_t) (1<<0);
      MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x00, irqSts1Reg);
    }
    MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x3D, pwrModesReg);
  }
...
)
{
  ...
  pwrModesReg &= (uint8_t) ~( (1<<1) | (1<<4) | (1<<0) );
...
{
  volatile uint8_t * pinEnableRegBase = (volatile uint8_t *) &((((LLWU_MemMapPtr)0x4007C000u))->PE1);
...
{
  ((((LLWU_MemMapPtr)0x4007C000u))->ME) |= (uint8_t)(0x01 << (uint8_t) wakeupModule);
}
...
)
{
  ...
  if( (((((LLWU_MemMapPtr)0x4007C000u))->ME) & ( (uint8_t) (1 << gPWRLib_LLWU_WakeupModule_LPTMR_c ) )) == ( (uint8_t) (1 << gPWRLib_LLWU_WakeupModule_LPTMR_c ) ) )
  {
    if( (((((LLWU_MemMapPtr)0x4007C000u))->F3) & ( (uint8_t) (1 << gPWRLib_LLWU_WakeupModule_LPTMR_c ) )) == ( (uint8_t) (1 << gPWRLib_LLWU_WakeupModule_LPTMR_c ) ) )
    {
      return 1;
    }
  }
...
)
{
  ...
  if( (((((LLWU_MemMapPtr)0x4007C000u))->ME) & ( (uint8_t) (1 << gPWRLib_LLWU_WakeupModule_RTC_Alarm_c ) )) == ( (uint8_t) (1 << gPWRLib_LLWU_WakeupModule_RTC_Alarm_c ) ) )
  {
    if( (((((LLWU_MemMapPtr)0x4007C000u))->F3) & ( (uint8_t) (1 << gPWRLib_LLWU_WakeupModule_RTC_Alarm_c ) )) == ( (uint8_t) (1 << gPWRLib_LLWU_WakeupModule_RTC_Alarm_c ) ) )
    {
      return 1;
    }
  }
...
)
{
  ...
  llwuPinEnableReg = (uint32_t) (((((LLWU_MemMapPtr)0x4007C000u))->PE1) << 0);
  llwuPinEnableReg |= (uint32_t) (((((LLWU_MemMapPtr)0x4007C000u))->PE2) << 8);
  llwuPinEnableReg |= (uint32_t) (((((LLWU_MemMapPtr)0x4007C000u))->PE3) << 16);
  llwuPinEnableReg |= (uint32_t) (((((LLWU_MemMapPtr)0x4007C000u))->PE4) << 24);

  llwuFlagReg = (uint32_t) (((((LLWU_MemMapPtr)0x4007C000u))->F1) << 0);
  llwuFlagReg |= (uint32_t) (((((LLWU_MemMapPtr)0x4007C000u))->F2) << 8);
...
)
{
  ...
  ((((SIM_MemMapPtr)0x40047000u))->SCGC5) |= 0x1u;
  ...
  if(Ticks != 0)
  {
    ((((LPTMR_MemMapPtr)0x40040000u))->CMR) = (uint16_t) (Ticks - 1);
  }
  else
  {
    ((((LPTMR_MemMapPtr)0x40040000u))->CMR) = (uint16_t) Ticks;
  }
  ...
  ((((LPTMR_MemMapPtr)0x40040000u))->PSR) = (ClkMode | 1);
  
   
  ((((LPTMR_MemMapPtr)0x40040000u))->CSR) = ( 0x80u |
                 0x40u | 
                 0x4u);
  ((((LPTMR_MemMapPtr)0x40040000u))->CSR) |= 0x1u;
...
)
{
  ...
  if(((((LPTMR_MemMapPtr)0x40040000u))->CSR) & 0x1u)
  {
     
    if(((((LPTMR_MemMapPtr)0x40040000u))->CSR) & 0x80u)
    {
      remTicks = 0;
    }
    else
    {
      ((((LPTMR_MemMapPtr)0x40040000u))->CNR) = ((((LPTMR_MemMapPtr)0x40040000u))->CNR);
      remTicks = mPWRLib_RTIRemainingTicks - ((((LPTMR_MemMapPtr)0x40040000u))->CNR);
    }
  }
...
)
{
  ...
  if(((((LPTMR_MemMapPtr)0x40040000u))->CSR) & 0x1u)
  {
    ...
    {
      ((((LPTMR_MemMapPtr)0x40040000u))->CNR) = ((((LPTMR_MemMapPtr)0x40040000u))->CNR);
      mPWRLib_RTIRemainingTicks = mPWRLib_RTIRemainingTicks - ((((LPTMR_MemMapPtr)0x40040000u))->CNR);
    }
  }
...
)
{
  ...
  ((((RTC_MemMapPtr)0x4003D000u))->CR) |= 0x4u;
   
  ((((RTC_MemMapPtr)0x4003D000u))->TAR) = 0;
  ((((RTC_MemMapPtr)0x4003D000u))->TSR) = 0;
  ...
  ((((RTC_MemMapPtr)0x4003D000u))->CR) |= 0x100u;
  
  mPWRLib_RTC_IsOscStarted = 0;
   
  mPWRLib_RTC_OscInitTmrID = TMR_AllocateTimer();	
  
  if(0xFF != mPWRLib_RTC_OscInitTmrID)
  {	
    TMR_StartTimer(mPWRLib_RTC_OscInitTmrID, 0x01, 1000, PWRLib_RTC_OscInitCallback);
  }	
...
)
{
  ...
  if(Ticks != 0)
  {
    ((((RTC_MemMapPtr)0x4003D000u))->TAR) = Ticks - 1;
  }
  else
  {
    ((((RTC_MemMapPtr)0x4003D000u))->TAR) = Ticks;
  }
...
)
{
  ...
  if(((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x10u)
  {
     
    if(((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x4u)
    {
      remTicks = 0;
    }
    else
    {
      remTicks = mPWRLib_RTIRemainingTicks - ((((RTC_MemMapPtr)0x4003D000u))->TSR);
    }
  }
...
)
{
  ...
  if(((((RTC_MemMapPtr)0x4003D000u))->SR) & 0x10u)
  {
    ...
    {
      mPWRLib_RTIRemainingTicks = mPWRLib_RTIRemainingTicks - ((((RTC_MemMapPtr)0x4003D000u))->TSR);
    }
  }
...
)
{
    ...
    ((((LPTMR_MemMapPtr)0x40040000u))->CMR) = val;
    
     
    ((((LPTMR_MemMapPtr)0x40040000u))->PSR) = (((uint32_t)(((uint32_t)(1))<<0))&0x3u)|0x4u;
    
     
    ((((LPTMR_MemMapPtr)0x40040000u))->CSR) |= 0x1u;
    
     
    while (!(((((LPTMR_MemMapPtr)0x40040000u))->CSR) & 0x80u)) {}
...
)
{
  ...
  if (((((LLWU_MemMapPtr)0x4007C000u))->F2) & 0x1u)
  {
    ((((PORT_MemMapPtr)0x4004B000u))->PCR[4]) |= 0x1000000u; 
    ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x1u;   
        PWRLib_MCU_WakeupReason.Bits.FromKeyBoard = 1;
  }
  if (((((LLWU_MemMapPtr)0x4007C000u))->F2) & 0x2u)
  {
    ((((PORT_MemMapPtr)0x4004B000u))->PCR[5]) |= 0x1000000u;
    ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x2u;   
	PWRLib_MCU_WakeupReason.Bits.FromKeyBoard = 1;
  }
  if (((((LLWU_MemMapPtr)0x4007C000u))->F2) & 0x4u)
  {
    ((((PORT_MemMapPtr)0x4004B000u))->PCR[6]) |= 0x1000000u;
    ((((LLWU_MemMapPtr)0x4007C000u))->F2) |= 0x4u;   
	PWRLib_MCU_WakeupReason.Bits.FromKeyBoard = 1;
  }
  
   
  ((((LLWU_MemMapPtr)0x4007C000u))->F1) = ((((LLWU_MemMapPtr)0x4007C000u))->F1);
  ((((LLWU_MemMapPtr)0x4007C000u))->F2) = ((((LLWU_MemMapPtr)0x4007C000u))->F2);
  
   
  ((((LLWU_MemMapPtr)0x4007C000u))->F3) |= 0x80u;

  
   
  if(((((LLWU_MemMapPtr)0x4007C000u))->F3) & 0x1u)
  {
  ...
  if(((((LLWU_MemMapPtr)0x4007C000u))->F3) & 0x20u)
  {
...
)
{
  ...
  resetStatus = (uint16_t) (((((RCM_MemMapPtr)0x4007F000u))->SRS0));
  resetStatus |= (uint16_t)(((((RCM_MemMapPtr)0x4007F000u))->SRS1) << 8);
  return resetStatus;
}
...
)
{
  ...
  PWRLib_LLWU_WakeupPinEnable( (PWRLib_LLWU_WakeupPin_t) (8), gPWRLib_LLWU_WakeupPin_AnyEdge_c);
  ...
  ((((PMC_MemMapPtr)0x4007D000u))->LVDSC1) &= (uint32_t) ~( 0x20u );
  ((((PMC_MemMapPtr)0x4007D000u))->LVDSC2) &= (uint32_t) ~( 0x20u );
...
{
  ((((SCB_MemMapPtr)0xE000E000u))->AIRCR) = (uint32_t) ((((uint32_t)(((uint32_t)(0x5FA))<<16))&0xFFFF0000u) | 0x4u);
  while(1);
}
