...
void PhyXtalAdjust(uint8_t u8Value)
{
   ...
   MC1324xDrv_IndirectAccessSPIWrite(0x01,u8Value);
...
void PhyWakeRequest(void)
{
   ...
   phyPwrModesReg = MC1324xDrv_DirectAccessSPIRead(0x3D);
   phyPwrModesReg |= (0x11);     
   MC1324xDrv_DirectAccessSPIWrite(0x3D,phyPwrModesReg);
}
 ...
 {  
   return MC1324xDrv_IndirectAccessSPIRead(0x00);
 }
