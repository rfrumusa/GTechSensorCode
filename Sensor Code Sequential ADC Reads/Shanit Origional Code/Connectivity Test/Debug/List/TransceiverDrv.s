///////////////////////////////////////////////////////////////////////////////
//
// IAR ANSI C/C++ Compiler V7.20.5.7591/W32 for ARM       20/Mar/2018  09:41:52
...
//        C:\Users\rfrum\OneDrive\2018 Spring Semester\Senior Design\Sensor
//        Code\Shanit Origional Code\Connectivity
//        Test\Debug\List\TransceiverDrv.s
//
///////////////////////////////////////////////////////////////////////////////
        ...
        PUBLIC MC1324xDrv_DirectAccessSPIMultiByteRead
        PUBLIC MC1324xDrv_DirectAccessSPIMultiByteWrite
        PUBLIC MC1324xDrv_DirectAccessSPIRead
        PUBLIC MC1324xDrv_DirectAccessSPIWrite
        PUBLIC MC1324xDrv_IRQ_Clear
        PUBLIC MC1324xDrv_IRQ_Disable
        PUBLIC MC1324xDrv_IRQ_Enable
        PUBLIC MC1324xDrv_IRQ_PortConfig
        PUBLIC MC1324xDrv_IndirectAccessSPIMultiByteRead
        PUBLIC MC1324xDrv_IndirectAccessSPIMultiByteWrite
        PUBLIC MC1324xDrv_IndirectAccessSPIRead
        PUBLIC MC1324xDrv_IndirectAccessSPIWrite
        PUBLIC MC1324xDrv_IsIrqPending
        PUBLIC MC1324xDrv_PB_SPIBurstRead
        PUBLIC MC1324xDrv_PB_SPIBurstWrite
        PUBLIC MC1324xDrv_RESET
        PUBLIC MC1324xDrv_RST_B_Assert
        PUBLIC MC1324xDrv_RST_B_Deassert
        PUBLIC MC1324xDrv_RST_B_PortConfig
        PUBLIC MC1324xDrv_SPIInit
        PUBLIC MC1324xDrv_Set_CLK_OUT_Freq
        PUBLIC MC1324xDrv_SoftRST_Assert
        PUBLIC MC1324xDrv_SoftRST_Deassert
        PUBLIC MC1324xDrv_Soft_RESET
        PUBLIC mLastSpiDMA_PUSH_Reg
        PUBLIC mSpiDMA_PUSH_Reg

// C:\Users\rfrum\OneDrive\2018 Spring Semester\Senior Design\Sensor Code\Shanit Origional Code\Connectivity Test\PLM\Source\Radio\MC1324x\DRV\TransceiverDrv.c
//    1 /*****************************************************************************
//    2  *                               INCLUDED HEADERS                            *
//    3  *---------------------------------------------------------------------------*
...
MC1324xDrv_SPIInit:
        LDR.W    R0,??DataTable18  ;; 0x40048038
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x400
        LDR.W    R1,??DataTable18  ;; 0x40048038
        STR      R0,[R1, #+0]
//   81   
//   82   /* Enable SPI clock */ 
//   83   MC1324x_SPI_SIM_SCG |= cSPI_SIM_SCG_Config_c;
        LDR.W    R0,??DataTable19  ;; 0x4004803c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x2000
        LDR.W    R1,??DataTable19  ;; 0x4004803c
        STR      R0,[R1, #+0]
//   84   
//   85   /* Initialize SPI Pin Control registers */
//   86   
//   87   MC1324x_SPI_SSEL_PCR &= ~PORT_PCR_MUX_MASK;
        LDR.W    R0,??DataTable19_1  ;; 0x4004a028
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        LDR.W    R1,??DataTable19_1  ;; 0x4004a028
        STR      R0,[R1, #+0]
...
//   89   MC1324x_SPI_SCLK_PCR &= ~PORT_PCR_MUX_MASK;
        LDR.W    R0,??DataTable19_2  ;; 0x4004a02c
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        LDR.W    R1,??DataTable19_2  ;; 0x4004a02c
        STR      R0,[R1, #+0]
...
//   91   MC1324x_SPI_MOSI_PCR &= ~PORT_PCR_MUX_MASK;
        LDR.W    R0,??DataTable19_3  ;; 0x4004a040
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        LDR.W    R1,??DataTable19_3  ;; 0x4004a040
        STR      R0,[R1, #+0]
...
//   93   MC1324x_SPI_MISO_PCR &= ~PORT_PCR_MUX_MASK;
        LDR.W    R0,??DataTable19_4  ;; 0x4004a044
        LDR      R0,[R0, #+0]
        BICS     R0,R0,#0x700
        LDR.W    R1,??DataTable19_4  ;; 0x4004a044
        STR      R0,[R1, #+0]
...
//   97   MC1324x_SPI_MCR = cSPI_MCR_Config_c;
        LDR.W    R0,??DataTable19_5  ;; 0x81013c01
        LDR.W    R1,??DataTable19_6  ;; 0x4002d000
        STR      R0,[R1, #+0]
//   98   MC1324x_SPI_CTAR0 = cSPI_CTAR0_Config_c;
        LDR.W    R0,??DataTable19_7  ;; 0x38000012
        LDR.W    R1,??DataTable19_8  ;; 0x4002d00c
        STR      R0,[R1, #+0]
//   99   MC1324x_SPI_CTAR1 = cSPI_CTAR1_Config_c;
        LDR.W    R0,??DataTable19_9  ;; 0x38010012
        LDR.W    R1,??DataTable19_10  ;; 0x4002d010
        STR      R0,[R1, #+0]
//  100   MC1324x_SPI_RSER = cSPI_RSER_Config_c;
        MOVS     R0,#+0
        LDR.W    R1,??DataTable19_11  ;; 0x4002d030
        STR      R0,[R1, #+0]
//  101   
//  102 }
        BX       LR               ;; return
...
//  360 )
//  361 {
MC1324xDrv_DirectAccessSPIWrite:
        PUSH     {R3-R7,LR}
        MOVS     R4,R0
        MOVS     R5,R1
...
//  366     
//  367   FlushSPIFifo();
        LDR.W    R0,??DataTable19_6  ;; 0x4002d000
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0xC00
        LDR.W    R1,??DataTable19_6  ;; 0x4002d000
        STR      R0,[R1, #+0]
//  368   MC1324x_SPI_SR |= (uint32_t)(cSPI_SR_EOQF_MASK_c | cSPI_SR_TCF_MASK_c | cSPI_SR_RFDF_MASK_c);
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LDR.W    R1,??DataTable19_13  ;; 0x90020000
        ORRS     R0,R1,R0
        LDR.W    R1,??DataTable19_12  ;; 0x4002d02c
        STR      R0,[R1, #+0]
//  369 
...
//  373                                  cSPI_PUSHR_CTAS0_select_c);
        LDR.W    R0,??DataTable19_14  ;; 0x80010000
        ORRS     R6,R0,R6
//  374   
//  375   MC1324x_SPI_PUSHR = SPIPushRegister;
        LDR.W    R0,??DataTable19_15  ;; 0x4002d034
        STR      R6,[R0, #+0]
//  376   
...
//  380                                  cSPI_PUSHR_CTAS0_select_c);
        LDR.W    R0,??DataTable19_16  ;; 0x8010000
        ORRS     R6,R0,R6
//  381 
...
??MC1324xDrv_DirectAccessSPIWrite_0:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_DirectAccessSPIWrite_0
//  387   
...
//  406 )
//  407 {
MC1324xDrv_DirectAccessSPIMultiByteWrite:
        PUSH     {R3-R9,LR}
        MOVS     R4,R0
        MOVS     R5,R1
        MOVS     R6,R2
...
//  412   if( (numOfBytes == 0) || (byteArray == NULL) )
        ...
        CMP      R6,#+0
        BEQ.N    ??MC1324xDrv_DirectAccessSPIMultiByteWrite_0
        CMP      R5,#+0
        BNE.N    ??MC1324xDrv_DirectAccessSPIMultiByteWrite_1
//  413   {
//  414     return;
??MC1324xDrv_DirectAccessSPIMultiByteWrite_0:
        B.N      ??MC1324xDrv_DirectAccessSPIMultiByteWrite_2
//  415   }
//  416 
//  417   irqMaskRegister = IntDisableAll();
??MC1324xDrv_DirectAccessSPIMultiByteWrite_1:
        BL       IntDisableAll
        MOV      R9,R0
//  418     
//  419   FlushSPIFifo();
...
??MC1324xDrv_DirectAccessSPIMultiByteWrite_3:
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+2
        BLT.N    ??MC1324xDrv_DirectAccessSPIMultiByteWrite_4
        UXTB     R8,R8            ;; ZeroExt  R8,R8,#+24,#+24
        CMP      R8,#+4
        BGE.N    ??MC1324xDrv_DirectAccessSPIMultiByteWrite_4
//  431   {
...
//  438     fifoIdx++;
        ADDS     R8,R8,#+1
        B.N      ??MC1324xDrv_DirectAccessSPIMultiByteWrite_3
//  439   }
//  440   
//  441   StartSPITransfer();
??MC1324xDrv_DirectAccessSPIMultiByteWrite_4:
        LDR.W    R0,??DataTable19_6  ;; 0x4002d000
        LDR      R0,[R0, #+0]
        LSRS     R0,R0,#+1
        LSLS     R0,R0,#+1
...
??MC1324xDrv_DirectAccessSPIMultiByteWrite_5:
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+2
        BLT.N    ??MC1324xDrv_DirectAccessSPIMultiByteWrite_6
//  444   {
...
??MC1324xDrv_DirectAccessSPIMultiByteWrite_7:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_DirectAccessSPIMultiByteWrite_7
...
//  453     numOfBytes--;
        SUBS     R6,R6,#+1
        B.N      ??MC1324xDrv_DirectAccessSPIMultiByteWrite_5
//  454   }
//  455   
//  456   SPIPushRegister = (uint32_t) *(byteArray);
??MC1324xDrv_DirectAccessSPIMultiByteWrite_6:
        LDRB     R0,[R5, #+0]
        MOVS     R7,R0
...
??MC1324xDrv_DirectAccessSPIMultiByteWrite_8:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_DirectAccessSPIMultiByteWrite_8
...
??MC1324xDrv_DirectAccessSPIMultiByteWrite_9:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_DirectAccessSPIMultiByteWrite_9
//  466   
...
//  470   IntRestoreAll(irqMaskRegister);
        ...
        BL       IntRestoreAll
//  471 }
??MC1324xDrv_DirectAccessSPIMultiByteWrite_2:
...
//  489   if( (numOfBytes == 0) || (byteArray == NULL) )
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R5,#+0
        BEQ.N    ??MC1324xDrv_PB_SPIBurstWrite_0
        CMP      R4,#+0
        BNE.N    ??MC1324xDrv_PB_SPIBurstWrite_1
//  490   {
//  491     return;
??MC1324xDrv_PB_SPIBurstWrite_0:
        B.N      ??MC1324xDrv_PB_SPIBurstWrite_2
//  492   }
//  493 
//  494   irqMaskRegister = IntDisableAll();
??MC1324xDrv_PB_SPIBurstWrite_1:
        BL       IntDisableAll
        MOV      R8,R0
//  495     
//  496   FlushSPIFifo();
...
??MC1324xDrv_PB_SPIBurstWrite_3:
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R5,#+2
        BLT.N    ??MC1324xDrv_PB_SPIBurstWrite_4
        UXTB     R7,R7            ;; ZeroExt  R7,R7,#+24,#+24
        CMP      R7,#+4
        BGE.N    ??MC1324xDrv_PB_SPIBurstWrite_4
//  511   {
...
//  518     fifoIdx++;
        ADDS     R7,R7,#+1
        B.N      ??MC1324xDrv_PB_SPIBurstWrite_3
//  519   }
//  520   
//  521   StartSPITransfer();
??MC1324xDrv_PB_SPIBurstWrite_4:
        LDR.W    R0,??DataTable19_6  ;; 0x4002d000
        LDR      R0,[R0, #+0]
        LSRS     R0,R0,#+1
        LSLS     R0,R0,#+1
...
??MC1324xDrv_PB_SPIBurstWrite_5:
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R5,#+2
        BLT.N    ??MC1324xDrv_PB_SPIBurstWrite_6
//  524   {
...
??MC1324xDrv_PB_SPIBurstWrite_7:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_PB_SPIBurstWrite_7
...
//  533     numOfBytes--;
        SUBS     R5,R5,#+1
        B.N      ??MC1324xDrv_PB_SPIBurstWrite_5
//  534   }
//  535   
//  536   SPIPushRegister = (uint32_t) *(byteArray);
??MC1324xDrv_PB_SPIBurstWrite_6:
        LDRB     R0,[R4, #+0]
        MOVS     R6,R0
...
??MC1324xDrv_PB_SPIBurstWrite_8:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_PB_SPIBurstWrite_8
...
??MC1324xDrv_PB_SPIBurstWrite_9:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_PB_SPIBurstWrite_9
//  546   
...
//  564 )
//  565 {
MC1324xDrv_DirectAccessSPIRead:
        PUSH     {R3-R7,LR}
        MOVS     R4,R0
...
//  578                                  cSPI_PUSHR_CTAS1_select_c);
        LDR.W    R0,??DataTable19_17  ;; 0x90010000
        ORRS     R5,R0,R5
//  579   
...
//  584                                 cSPI_PUSHR_CTAS1_select_c);
        LDR.W    R0,??DataTable19_18  ;; 0x18010000
        MOVS     R5,R0
//  585 
...
??MC1324xDrv_DirectAccessSPIRead_0:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_DirectAccessSPIRead_0
//  591   
...
//  596   SPIPopRegister = MC1324x_SPI_RXFR1;
        LDR.W    R0,??DataTable19_19  ;; 0x4002d080
        LDR      R0,[R0, #+0]
        MOVS     R6,R0
//  597 
//  598   FlushSPIFifo();
...
//  617 )
//  618 {
MC1324xDrv_DirectAccessSPIMultiByteRead:
        PUSH     {R4-R8,LR}
        MOVS     R4,R0
        MOVS     R5,R1
        MOVS     R6,R2
...
//  622   if( (numOfBytes == 0) || (byteArray == NULL) )
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+0
        BEQ.N    ??MC1324xDrv_DirectAccessSPIMultiByteRead_0
        CMP      R5,#+0
        BNE.N    ??MC1324xDrv_DirectAccessSPIMultiByteRead_1
//  623   {
//  624     return;
??MC1324xDrv_DirectAccessSPIMultiByteRead_0:
        B.N      ??MC1324xDrv_DirectAccessSPIMultiByteRead_2
//  625   }
//  626   
//  627   //asm(" MRS %0,PRIMASK" : "=r" (irqMaskRegister) );
//  628   //asm(" CPSID i");
//  629   irqMaskRegister = IntDisableAll();
??MC1324xDrv_DirectAccessSPIMultiByteRead_1:
        BL       IntDisableAll
        MOV      R8,R0
//  630      
//  631   FlushSPIFifo();
...
??MC1324xDrv_DirectAccessSPIMultiByteRead_3:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_DirectAccessSPIMultiByteRead_3
...
??MC1324xDrv_DirectAccessSPIMultiByteRead_4:
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+2
        BLT.N    ??MC1324xDrv_DirectAccessSPIMultiByteRead_5
//  651   {
...
??MC1324xDrv_DirectAccessSPIMultiByteRead_6:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_DirectAccessSPIMultiByteRead_6
...
//  662     *byteArray++ = MC1324x_SPI_POPR;
        LDR.W    R0,??DataTable19_20  ;; 0x4002d038
        LDR      R0,[R0, #+0]
        STRB     R0,[R5, #+0]
        ADDS     R5,R5,#+1
//  663     
//  664     numOfBytes--;
        SUBS     R6,R6,#+1
        B.N      ??MC1324xDrv_DirectAccessSPIMultiByteRead_4
//  665   }
//  666   
//  667   SPIPushRegister = (uint32_t) 0;
??MC1324xDrv_DirectAccessSPIMultiByteRead_5:
        MOVS     R0,#+0
        MOVS     R7,R0
...
??MC1324xDrv_DirectAccessSPIMultiByteRead_7:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_DirectAccessSPIMultiByteRead_7
//  675   
...
//  685   IntRestoreAll(irqMaskRegister);
        ...
        BL       IntRestoreAll
//  686 }
??MC1324xDrv_DirectAccessSPIMultiByteRead_2:
        POP      {R4-R8,PC}       ;; return
//  687 
//  688 /*---------------------------------------------------------------------------
...
//  703   if( (numOfBytes == 0) || (byteArray == NULL) )
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R5,#+0
        BEQ.N    ??MC1324xDrv_PB_SPIBurstRead_0
        CMP      R4,#+0
        BNE.N    ??MC1324xDrv_PB_SPIBurstRead_1
//  704   {
//  705     return;
??MC1324xDrv_PB_SPIBurstRead_0:
        B.N      ??MC1324xDrv_PB_SPIBurstRead_2
//  706   }
//  707   
//  708   //asm(" MRS %0,PRIMASK" : "=r" (irqMaskRegister) );
//  709   //asm(" CPSID i");
//  710   irqMaskRegister = IntDisableAll();
??MC1324xDrv_PB_SPIBurstRead_1:
        BL       IntDisableAll
        MOVS     R7,R0
//  711      
//  712   FlushSPIFifo();
...
??MC1324xDrv_PB_SPIBurstRead_3:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_PB_SPIBurstRead_3
...
??MC1324xDrv_PB_SPIBurstRead_4:
        UXTB     R5,R5            ;; ZeroExt  R5,R5,#+24,#+24
        CMP      R5,#+2
        BLT.N    ??MC1324xDrv_PB_SPIBurstRead_5
//  734   {
...
??MC1324xDrv_PB_SPIBurstRead_6:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_PB_SPIBurstRead_6
...
//  747     numOfBytes--;
        SUBS     R5,R5,#+1
        B.N      ??MC1324xDrv_PB_SPIBurstRead_4
//  748   }
//  749   
//  750   SPIPushRegister = (uint32_t) 0;
??MC1324xDrv_PB_SPIBurstRead_5:
        MOVS     R0,#+0
        MOVS     R6,R0
...
??MC1324xDrv_PB_SPIBurstRead_7:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_PB_SPIBurstRead_7
//  758   
...
//  781 )
//  782 {
MC1324xDrv_IndirectAccessSPIWrite:
        PUSH     {R3-R7,LR}
        MOVS     R4,R0
        MOVS     R5,R1
...
??MC1324xDrv_IndirectAccessSPIWrite_0:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_IndirectAccessSPIWrite_0
//  816   
...
//  836 )
//  837 {
MC1324xDrv_IndirectAccessSPIMultiByteWrite:
        PUSH     {R3-R9,LR}
        MOVS     R4,R0
        MOVS     R5,R1
        MOVS     R6,R2
...
//  842   if( (numOfBytes == 0) || (byteArray == NULL) )
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+0
        BEQ.N    ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_0
        CMP      R5,#+0
        BNE.N    ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_1
//  843   {
//  844     return;
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_0:
        B.N      ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_2
//  845   }
//  846   
//  847   //asm(" MRS %0,PRIMASK" : "=r" (irqMaskRegister) );
//  848   //asm(" CPSID i");
//  849   irqMaskRegister = IntDisableAll();
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_1:
        BL       IntDisableAll
        MOV      R9,R0
//  850     
//  851   FlushSPIFifo();
...
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_3:
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+2
        BLT.N    ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_4
        UXTB     R8,R8            ;; ZeroExt  R8,R8,#+24,#+24
        CMP      R8,#+4
        BGE.N    ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_4
//  870   {
...
//  877     numOfBytes--;
        SUBS     R6,R6,#+1
        B.N      ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_3
//  878   }
//  879   
//  880   StartSPITransfer();
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_4:
        LDR.W    R0,??DataTable19_6  ;; 0x4002d000
        LDR      R0,[R0, #+0]
        LSRS     R0,R0,#+1
        LSLS     R0,R0,#+1
...
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_5:
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+2
        BLT.N    ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_6
//  883   {
...
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_7:
        LDR.W    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_7
...
//  892     numOfBytes--;
        SUBS     R6,R6,#+1
        B.N      ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_5
//  893   }
//  894   
//  895   SPIPushRegister = (uint32_t) *(byteArray);
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_6:
        LDRB     R0,[R5, #+0]
        MOVS     R7,R0
...
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_8:
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_8
//  900   ClearSPI_TransferCompleteFlag();
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x80000000
        LDR.N    R1,??DataTable19_12  ;; 0x4002d02c
        STR      R0,[R1, #+0]
//  901   
//  902   MC1324x_SPI_PUSHR = SPIPushRegister;
        LDR.N    R0,??DataTable19_15  ;; 0x4002d034
        STR      R7,[R0, #+0]
//  903   
//  904   WaitSPI_EndOfQueueFlag();
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_9:
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_IndirectAccessSPIMultiByteWrite_9
//  905   
//  906   MC1324x_SPI_SR |= (uint32_t)(cSPI_SR_EOQF_MASK_c | cSPI_SR_TCF_MASK_c | cSPI_SR_RFDF_MASK_c);
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LDR.N    R1,??DataTable19_13  ;; 0x90020000
        ORRS     R0,R1,R0
        LDR.N    R1,??DataTable19_12  ;; 0x4002d02c
        STR      R0,[R1, #+0]
//  907   StopSPITransferAndFlushFifo();
        LDR.N    R0,??DataTable19_6  ;; 0x4002d000
        LDR      R0,[R0, #+0]
        MOVW     R1,#+3073
        ORRS     R0,R1,R0
        LDR.N    R1,??DataTable19_6  ;; 0x4002d000
        STR      R0,[R1, #+0]
//  908   
...
//  910   IntRestoreAll(irqMaskRegister);
        ...
        BL       IntRestoreAll
//  911 }
??MC1324xDrv_IndirectAccessSPIMultiByteWrite_2:
        POP      {R0,R4-R9,PC}    ;; return
//  912 
//  913 /*---------------------------------------------------------------------------
...
//  922 )
//  923 {
MC1324xDrv_IndirectAccessSPIRead:
        PUSH     {R3-R7,LR}
        MOVS     R4,R0
...
//  936                                  cSPI_PUSHR_CTAS1_select_c);
        LDR.N    R0,??DataTable19_17  ;; 0x90010000
        ORRS     R6,R0,R6
//  937   
...
//  949                                 cSPI_PUSHR_CTAS1_select_c);
        LDR.N    R0,??DataTable19_18  ;; 0x18010000
        MOVS     R6,R0
//  950   
...
??MC1324xDrv_IndirectAccessSPIRead_0:
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_IndirectAccessSPIRead_0
//  956  
...
//  961   SPIPopRegister = MC1324x_SPI_RXFR2;
        LDR.N    R0,??DataTable19_21  ;; 0x4002d084
        LDR      R0,[R0, #+0]
        MOVS     R5,R0
//  962 
//  963   FlushSPIFifo();
...
//  982 )
//  983 {
MC1324xDrv_IndirectAccessSPIMultiByteRead:
        PUSH     {R4-R8,LR}
        MOVS     R4,R0
        MOVS     R5,R1
        MOVS     R6,R2
...
//  987   if( (numOfBytes == 0) || (byteArray == NULL) )
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+0
        BEQ.N    ??MC1324xDrv_IndirectAccessSPIMultiByteRead_0
        CMP      R5,#+0
        BNE.N    ??MC1324xDrv_IndirectAccessSPIMultiByteRead_1
//  988   {
//  989     return;
??MC1324xDrv_IndirectAccessSPIMultiByteRead_0:
        B.N      ??MC1324xDrv_IndirectAccessSPIMultiByteRead_2
//  990   }
//  991   
//  992   //asm(" MRS %0,PRIMASK" : "=r" (irqMaskRegister) );
//  993   //asm(" CPSID i");
//  994   irqMaskRegister = IntDisableAll();
??MC1324xDrv_IndirectAccessSPIMultiByteRead_1:
        BL       IntDisableAll
        MOV      R8,R0
//  995     
//  996   FlushSPIFifo();
...
??MC1324xDrv_IndirectAccessSPIMultiByteRead_3:
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_IndirectAccessSPIMultiByteRead_3
...
??MC1324xDrv_IndirectAccessSPIMultiByteRead_4:
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_IndirectAccessSPIMultiByteRead_4
...
??MC1324xDrv_IndirectAccessSPIMultiByteRead_5:
        UXTB     R6,R6            ;; ZeroExt  R6,R6,#+24,#+24
        CMP      R6,#+2
        BLT.N    ??MC1324xDrv_IndirectAccessSPIMultiByteRead_6
// 1025   {
...
??MC1324xDrv_IndirectAccessSPIMultiByteRead_7:
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        CMP      R0,#+0
        BPL.N    ??MC1324xDrv_IndirectAccessSPIMultiByteRead_7
...
// 1036     *byteArray++ = MC1324x_SPI_POPR;
        LDR.N    R0,??DataTable19_20  ;; 0x4002d038
        LDR      R0,[R0, #+0]
        STRB     R0,[R5, #+0]
        ADDS     R5,R5,#+1
// 1037     
// 1038     numOfBytes--;
        SUBS     R6,R6,#+1
        B.N      ??MC1324xDrv_IndirectAccessSPIMultiByteRead_5
// 1039   }
// 1040   
// 1041   SPIPushRegister = (uint32_t) 0;
??MC1324xDrv_IndirectAccessSPIMultiByteRead_6:
        MOVS     R0,#+0
        MOVS     R7,R0
...
??MC1324xDrv_IndirectAccessSPIMultiByteRead_8:
        LDR.N    R0,??DataTable19_12  ;; 0x4002d02c
        LDR      R0,[R0, #+0]
        LSLS     R0,R0,#+3
        BPL.N    ??MC1324xDrv_IndirectAccessSPIMultiByteRead_8
// 1049   
...
// 1059   IntRestoreAll(irqMaskRegister);
        ...
        BL       IntRestoreAll
// 1060 }
??MC1324xDrv_IndirectAccessSPIMultiByteRead_2:
        POP      {R4-R8,PC}       ;; return
// 1061 
// 1062 /*---------------------------------------------------------------------------
...
MC1324xDrv_IRQ_PortConfig:
        LDR.N    R0,??DataTable18  ;; 0x40048038
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x400
        LDR.N    R1,??DataTable18  ;; 0x40048038
        STR      R0,[R1, #+0]
// 1074   MC1324x_IRQ_PCR |= cIRQ_PCR_Config_c;
        LDR.N    R0,??DataTable19_22  ;; 0x4004a00c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x100
        LDR.N    R1,??DataTable19_22  ;; 0x4004a00c
        STR      R0,[R1, #+0]
// 1075 }
        BX       LR               ;; return
// 1076 
...
// 1151   MC1324x_RST_PCR |= cRST_PCR_Config_c;
        LDR.N    R0,??DataTable19_24  ;; 0x4004a04c
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x140
        LDR.N    R1,??DataTable19_24  ;; 0x4004a04c
        STR      R0,[R1, #+0]
// 1152   MC1324x_RST_PSOR |= (uint32_t)Radio_RST_PinNumberMask_c;
        LDR.N    R0,??DataTable19_25  ;; 0x400ff044
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x80000
        LDR.N    R1,??DataTable19_25  ;; 0x400ff044
        STR      R0,[R1, #+0]
// 1153   MC1324x_RST_PDDR |= (uint32_t)Radio_RST_PinNumberMask_c;
        LDR.N    R0,??DataTable19_26  ;; 0x400ff054
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x80000
        LDR.N    R1,??DataTable19_26  ;; 0x400ff054
        STR      R0,[R1, #+0]
// 1154 }
        BX       LR               ;; return
// 1155 
...
MC1324xDrv_RST_B_Assert:
        LDR.N    R0,??DataTable19_27  ;; 0x400ff048
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x80000
        LDR.N    R1,??DataTable19_27  ;; 0x400ff048
        STR      R0,[R1, #+0]
// 1168 }
        BX       LR               ;; return
// 1169 
...
// 1262   if(freqDiv == gCLK_OUT_FREQ_DISABLE)
        UXTB     R4,R4            ;; ZeroExt  R4,R4,#+24,#+24
        CMP      R4,#+8
        BNE.N    ??MC1324xDrv_Set_CLK_OUT_Freq_0
// 1263   {
