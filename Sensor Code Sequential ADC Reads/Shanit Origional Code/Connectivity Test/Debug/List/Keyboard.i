...
void KeyboardInit (void)
{
  ((((SIM_MemMapPtr)0x40047000u))->SCGC5) |= (1<<11);
  ((((PORT_MemMapPtr)0x4004B000u))->PCR[4]) =  0x1u | 0x2u | (((uint32_t)(((uint32_t)(1))<<8))&0x700u) | (((uint32_t)(((uint32_t)(10))<<16))&0xF0000u);
  ((((PORT_MemMapPtr)0x4004B000u))->PCR[5]) =  0x1u | 0x2u | (((uint32_t)(((uint32_t)(1))<<8))&0x700u) | (((uint32_t)(((uint32_t)(10))<<16))&0xF0000u);
  ((((PORT_MemMapPtr)0x4004B000u))->PCR[6]) =  0x1u | 0x2u | (((uint32_t)(((uint32_t)(1))<<8))&0x700u) | (((uint32_t)(((uint32_t)(10))<<16))&0xF0000u);
  ((((PORT_MemMapPtr)0x4004B000u))->PCR[7]) =  0x1u | 0x2u | (((uint32_t)(((uint32_t)(1))<<8))&0x700u) | (((uint32_t)(((uint32_t)(10))<<16))&0xF0000u);
  NVIC_EnableIRQ((61));
...
{
   if (0x1000000u & ((((PORT_MemMapPtr)0x4004B000u))->PCR[4]))
   {     
     (((((GPIO_MemMapPtr)0x400FF0C0u))->PTOR) |= (1<<7));      
   }  
   if (((((PORT_MemMapPtr)0x4004B000u))->PCR[5]) & 0x1000000u)
   {    
     (((((GPIO_MemMapPtr)0x400FF0C0u))->PTOR) |= (1<<6));      
   }  
    if (((((PORT_MemMapPtr)0x4004B000u))->PCR[6]) & 0x1000000u)
   {    
     (((((GPIO_MemMapPtr)0x400FF0C0u))->PTOR) |= (1<<5));      
   }  
    if (((((PORT_MemMapPtr)0x4004B000u))->PCR[7]) & 0x1000000u)
   {    
     (((((GPIO_MemMapPtr)0x400FF0C0u))->PTOR) |= (1<<4));      
   }  
   
   ((((PORT_MemMapPtr)0x4004B000u))->ISFR) |= (1<<4) | (1<<5) | (1<<6) | (1<<7); 
}
