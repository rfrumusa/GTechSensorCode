...
)
{
  ...
  irqSts3Reg |= (uint8_t) ((1<<6));   
  
  
  MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x00, irqSts1Reg);
  MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x01, irqSts2Reg);
  MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x02, irqSts3Reg);
  
  MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x04, phyCtrl2Reg);
...
{
  volatile uint8_t phyCtrl1Reg, phyCtrl2Reg, irqSts1Reg, irqSts2Reg, irqSts3Reg; 
...
)
{
  ...
  phyCtrl4Reg &= (uint8_t) ~((3<<0) << (3));
  phyCtrl4Reg |= (uint8_t) (((3 << 0) & ccaParam) << ((3) - 0));
  MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x07, phyCtrl4Reg);
  
  
  if((1 << 7) & ccaParam)
  {
    phyCtrl1Reg |= (uint8_t) ((1<<6));
  }
  else
  {
    phyCtrl1Reg &= (uint8_t) ~((1<<6));
...
{
  MC1324xDrv_DirectAccessSPIWrite(0x23, ccaOffset);
  return 0;
}
...
{
  MC1324xDrv_DirectAccessSPIWrite(0x3C, clockOutRate);
  return 0;
}
...
{
  MC1324xDrv_IndirectAccessSPIWrite(0x28,timeBase);
  return 0;
...
)
{
  ...
  MC1324xDrv_DirectAccessSPIWrite(0x20, pll_int[channel - 11]);
  MC1324xDrv_DirectAccessSPIMultiByteWrite(0x21, (uint8_t *) &pll_frac[channel - 11], 2);
  return gPhySuccess_c;
}
...
)
{
  ...
  MC1324xDrv_DirectAccessSPIWrite(0x10, pll_int[channel - 11]);
  MC1324xDrv_DirectAccessSPIMultiByteWrite(0x11, (uint8_t *) &pll_frac[channel - 11], 2);
  return gPhySuccess_c;
}
...
)
{
  ...
  MC1324xDrv_DirectAccessSPIWrite(0x23, (uint8_t)(pwrStep & 0x1F));
  return gPhySuccess_c;
}
