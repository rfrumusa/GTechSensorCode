 ...
 
{
  ...
  ((((SIM_MemMapPtr)0x40047000u))->SCGC6) |= (uint32_t)(1<<27);
  
  ((((SIM_MemMapPtr)0x40047000u))->SCGC5) |= (uint32_t)(1<<13);
 
  ClearADCContents();
  
  ((((PORT_MemMapPtr)0x4004C000u))->PCR[6]) = (((uint32_t)(((uint32_t)(0x0))<<8))&0x700u);
  ((((PORT_MemMapPtr)0x4004C000u))->PCR[7]) = (((uint32_t)(((uint32_t)(0x0))<<8))&0x700u);
  
  
  
  ((((PORT_MemMapPtr)0x4004D000u))->PCR[16]) = (((uint32_t)(((uint32_t)(0x0))<<8))&0x700u);              
  ((((PORT_MemMapPtr)0x4004D000u))->PCR[17]) = (((uint32_t)(((uint32_t)(0x0))<<8))&0x700u);              
  ((((PORT_MemMapPtr)0x4004D000u))->PCR[18]) = (((uint32_t)(((uint32_t)(0x0))<<8))&0x700u);              
  ((((PORT_MemMapPtr)0x4004D000u))->PCR[19]) = (((uint32_t)(((uint32_t)(0x0))<<8))&0x700u);              
  
   ((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) |= (uint32_t)0x16; 
   
  
  ((((ADC_MemMapPtr)0x4003B000u))->CFG1) |= (uint32_t)0x1F9;
  
  ((((ADC_MemMapPtr)0x4003B000u))->SC3) = (uint32_t)0xf;
  
  
  ((((ADC_MemMapPtr)0x4003B000u))->SC3) |= (uint32_t)(1<<6);
  
 while(((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) & 0x80u)
   {
    
  }
  
  if(((((ADC_MemMapPtr)0x4003B000u))->SC3) & 0x40u)
  {
  ...
  PlusSideConv= ((((ADC_MemMapPtr)0x4003B000u))->CLP0) + ((((ADC_MemMapPtr)0x4003B000u))->CLP1) + ((((ADC_MemMapPtr)0x4003B000u))->CLP2) + ((((ADC_MemMapPtr)0x4003B000u))->CLP3) + ((((ADC_MemMapPtr)0x4003B000u))->CLP4) + ((((ADC_MemMapPtr)0x4003B000u))->CLPS);
  PlusSideConv = PlusSideConv /2;
  
  ((((ADC_MemMapPtr)0x4003B000u))->PG) = PlusSideConv | 0x8000;
  
  MinusSideConv= ((((ADC_MemMapPtr)0x4003B000u))->CLM0) + ((((ADC_MemMapPtr)0x4003B000u))->CLM1) + ((((ADC_MemMapPtr)0x4003B000u))->CLM2) + ((((ADC_MemMapPtr)0x4003B000u))->CLM3) + ((((ADC_MemMapPtr)0x4003B000u))->CLM4) + ((((ADC_MemMapPtr)0x4003B000u))->CLMS);
  MinusSideConv = MinusSideConv /2;
  
  ((((ADC_MemMapPtr)0x4003B000u))->MG) = MinusSideConv | 0x8000;
  
  ((((ADC_MemMapPtr)0x4003B000u))->SC2) = (uint32_t)0x0;
  
  
   
   ((((ADC_MemMapPtr)0x4003B000u))->CFG1) = (uint32_t)0x19;
   ((((ADC_MemMapPtr)0x4003B000u))->SC3) = (uint32_t)0x0;              
...
{
    ((((ADC_MemMapPtr)0x4003B000u))->CFG1) = (uint32_t)0x0;
    ((((ADC_MemMapPtr)0x4003B000u))->CFG2) = (uint32_t)0x0;
    ((((ADC_MemMapPtr)0x4003B000u))->CV1) = (uint32_t)0x0;
    ((((ADC_MemMapPtr)0x4003B000u))->CV2) = (uint32_t)0x0;
    ((((ADC_MemMapPtr)0x4003B000u))->SC2) = (uint32_t)0x0;
    ((((ADC_MemMapPtr)0x4003B000u))->SC3) = (uint32_t)0x0;
}
...
bool_t CheckConversionActive()
{
  if(((((ADC_MemMapPtr)0x4003B000u))->SC2) & 0x80u)
  {
    return 1;
  }
  return 0;
 ...
 
{
  ...
  if(((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) & 0x80u)
  {
    return 1;
  }
 ...
 
{
  ...
  if(((((ADC_MemMapPtr)0x4003B000u))->SC1[1]) & 0x80u)
  {
    return 1;
  }
 ...
 
{
  ...
  ((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) =  (uint32_t)0x7 ;
 ...
 
{
  ...
  ((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) =  (uint32_t)0x4 ;
 ...
 
{
  ...
  ((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) =  (uint32_t)0x5 ;
 ...
 
{
  ...
  ((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) =  (uint32_t)0x6 ;
...
{
  return ((((ADC_MemMapPtr)0x4003B000u))->R[1]);
}
...
{
  return ((((ADC_MemMapPtr)0x4003B000u))->R[0]);
}

void DisableADC()
{
  ((((ADC_MemMapPtr)0x4003B000u))->SC1[0]) = 0x1F;
  ((((ADC_MemMapPtr)0x4003B000u))->SC1[1]) = 0x1F;
}
...
void PDBinit()
{
  ...
  ((((SIM_MemMapPtr)0x40047000u))->SCGC6) |= (uint32_t) (1<<22);
  ((((PDB_MemMapPtr)0x40036000u))->SC) = (uint32_t)0x800;
  
  ((((PDB_MemMapPtr)0x40036000u))->MOD) = (uint32_t)0x1;
  
  ((((PDB_MemMapPtr)0x40036000u))->CH[0]. C1) = (uint32_t)0x1;
  
  ((((PDB_MemMapPtr)0x40036000u))->CH[0]. DLY[0]) = (uint32_t)0x0;
  ((((PDB_MemMapPtr)0x40036000u))->CH[1]. DLY[0]) = (uint32_t)0x0;
  ((((PDB_MemMapPtr)0x40036000u))->POEN) = (uint32_t)0x0;
...
void startOutputChanel1Timmer()
{
  ...
  ((((PDB_MemMapPtr)0x40036000u))->SC) = (uint32_t)0x821;
  
  ((((PDB_MemMapPtr)0x40036000u))->CH[0]. C1) = (uint32_t)0x3;
...
void startOutputChanel2Timmer()
{
  ...
  ((((PDB_MemMapPtr)0x40036000u))->CH[0]. C1) = (uint32_t)0xB;
