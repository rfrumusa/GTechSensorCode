...
)
{
    ...
    {
        ((((MCG_MemMapPtr)0x40064000u))->C3) = *((uint8_t*) 0x03FFU);
        ((((MCG_MemMapPtr)0x40064000u))->C4) = (((((MCG_MemMapPtr)0x40064000u))->C4) & 0xE0U) | ((*((uint8_t*) 0x03FEU)) & 0x1FU);
    }
    ...
    ((((MCG_MemMapPtr)0x40064000u))->C2) = (((uint8_t)(((uint8_t)(2))<<4))&0x30u) | 0x8u | 0x1u;
    ...
    ((((MCG_MemMapPtr)0x40064000u))->C5) = (((uint8_t)(((uint8_t)(1))<<0))&0x1Fu) | 0x40u;   
    ...
    if(((((MCG_MemMapPtr)0x40064000u))->SC) & 0x1u)
    {
      ((((MCG_MemMapPtr)0x40064000u))->SC) |= 0x1u;
    }

     
    ((((MCG_MemMapPtr)0x40064000u))->C6) = 0x40u | (((uint8_t)(((uint8_t)(0))<<0))&0x1Fu);  
    ...
    ((((OSC_MemMapPtr)0x40065000u))->CR) = 0x80u | 0x20u;    

         
    ((((MCG_MemMapPtr)0x40064000u))->C6) |= 0x20u;
...
)
{
    ...
    ((((MCG_MemMapPtr)0x40064000u))->C1) |= (((uint8_t)(((uint8_t)(2))<<6))&0xC0u);   
    ...
    ((((MCG_MemMapPtr)0x40064000u))->C2) &= ~0x2u;   
    ((((MCG_MemMapPtr)0x40064000u))->C2) |= 0x1u;   
    temp_reg = ((((MCG_MemMapPtr)0x40064000u))->C1);
    temp_reg &= ~(0xC0u | 0x4u);
    temp_reg |= ((((uint8_t)(((uint8_t)(1))<<6))&0xC0u) | 0x4u);   
    ((((MCG_MemMapPtr)0x40064000u))->C1) = temp_reg;

    while (((((MCG_MemMapPtr)0x40064000u))->S) & 0x10u) {};  
    while (((((((MCG_MemMapPtr)0x40064000u))->S) & 0xCu) >> 2) != 0x1) {};  

     
    ((((MCG_MemMapPtr)0x40064000u))->C1) |= 0x1u;   
    ((((MCG_MemMapPtr)0x40064000u))->C2) |= 0x2u;   
    while (!(((((MCG_MemMapPtr)0x40064000u))->S) & 0x10u)) {};  
    while (((((((MCG_MemMapPtr)0x40064000u))->S) & 0xCu) >> 2) != 0x1) {};  
...
)
{
    ...
    ((((MCG_MemMapPtr)0x40064000u))->C2) &= ~0x2u;   
    temp_reg = ((((MCG_MemMapPtr)0x40064000u))->C2);   
    temp_reg &= ~0x30u;   
    temp_reg |= (0x2 << 0x4);   
    ((((MCG_MemMapPtr)0x40064000u))->C2) = temp_reg;   
    ((((MCG_MemMapPtr)0x40064000u))->C4) = 0x0E;   
    ((((MCG_MemMapPtr)0x40064000u))->C1) = 0x04;   

     
    while (!(((((MCG_MemMapPtr)0x40064000u))->S) & 0x10u)) {};

     
    while (((((((MCG_MemMapPtr)0x40064000u))->S) & 0xCu) >> 2) != 0x0) {};
    ...
    gMCG_periphClkKHz = gMCG_coreClkKHz / (((((((SIM_MemMapPtr)0x40047000u))->CLKDIV1) & 0xF000000u) >> 24)+ 1);
...
)
{
    ...
    ((((MCG_MemMapPtr)0x40064000u))->C2) = (((uint8_t)(((uint8_t)(0))<<4))&0x30u);  
    ...
    while (((((((MCG_MemMapPtr)0x40064000u))->S) & 0xCu) >> 2)) {};
...
)
{
    ...
    ((((SIM_MemMapPtr)0x40047000u))->SCGC5) |= (uint32_t) 0x400u;
     
    ((((SIM_MemMapPtr)0x40047000u))->SCGC6) |= (uint32_t) 0x2000000u;
     
    ((((PORT_MemMapPtr)0x4004A000u))->PCR[18]) &= ~(uint32_t) 0x700u;
    ((((PORT_MemMapPtr)0x4004A000u))->PCR[18]) |= (((uint32_t)(((uint32_t)(3))<<8))&0x700u);  
     
    ((((FTM_MemMapPtr)0x40039000u))->SC) = (uint32_t) 0x08;
     
    ((((FTM_MemMapPtr)0x40039000u))->CONTROLS[0]. CnSC) = (uint32_t)0x28; 
     
    ((((FTM_MemMapPtr)0x40039000u))->MOD) = 1000;
     
    ((((FTM_MemMapPtr)0x40039000u))->CONTROLS[0]. CnV) = 500;
}
...
)
{
    ...
    ((((MCG_MemMapPtr)0x40064000u))->C4) = ( ((((MCG_MemMapPtr)0x40064000u))->C4) & ( 0x1Eu | 0x1u ) );

     
    ((((MCG_MemMapPtr)0x40064000u))->C1) |= 0x4u;

     
    while( (((((MCG_MemMapPtr)0x40064000u))->S) & 0x10u) !=  0x10u ){};
}
...
)
{
    ...
    while( (((((MCG_MemMapPtr)0x40064000u))->S) & 0x20u) ==  0x20u ){};

    

     
     
    mcgC1Reg  =  ((((MCG_MemMapPtr)0x40064000u))->C1);
    mcgC1Reg &= ~0xC0u;
    mcgC1Reg |=  0x4u;
    ((((MCG_MemMapPtr)0x40064000u))->C1)    =  mcgC1Reg;
