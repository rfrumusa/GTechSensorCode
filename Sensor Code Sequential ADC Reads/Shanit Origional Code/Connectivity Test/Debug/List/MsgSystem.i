...
uint8_t maMacHeap[((((5)) * (((((48) + (sizeof(uint8_t *)-1)) / sizeof(uint8_t *)) * sizeof(uint8_t *)) + sizeof(listHeader_t))) + (((10)) * (((((180) + (sizeof(uint8_t *)-1)) / sizeof(uint8_t *)) * sizeof(uint8_t *)) + sizeof(listHeader_t))) + (((3)) * (((((252) + (sizeof(uint8_t *)-1)) / sizeof(uint8_t *)) * sizeof(uint8_t *)) + sizeof(listHeader_t))))];
...
const poolInfo_t poolInfo[3] = {
  {(5), ((((48) + (sizeof(uint8_t *)-1)) / sizeof(uint8_t *)) * sizeof(uint8_t *)), ((((180) + (sizeof(uint8_t *)-1)) / sizeof(uint8_t *)) * sizeof(uint8_t *)), 0},
  {(10), ((((180) + (sizeof(uint8_t *)-1)) / sizeof(uint8_t *)) * sizeof(uint8_t *)), ((((252) + (sizeof(uint8_t *)-1)) / sizeof(uint8_t *)) * sizeof(uint8_t *)), 0},
  {(3), ((((252) + (sizeof(uint8_t *)-1)) / sizeof(uint8_t *)) * sizeof(uint8_t *)), 0, 0}
};
  ...
  )
{
  ...
  ;
  if (((( void * )( 0 )) == pBlock) || ((( void * )( 0 )) == pAnchor))
    return;

    
  pBlock = ((listHeader_t *)pBlock)-1;
    
  ((listHeader_t *)pBlock)->pNext = (( void * )( 0 ));
  ...
  )
{
  ...
  if(pPrevBlock) {
    ...
    (((listHeader_t *)pPrevBlock)-1)->pNext = nextBlock;
      
    if((((listHeader_t *)pPrevBlock)-1)->pNext == 0) {
      pAnchor->pTail = (((listHeader_t *)pPrevBlock)-1);
    }
  }
  else {
  ...
  while(numBytes)
  {
    if(numBytes <= pPools->blockSize)
    {
      ...
      if((( void * )( 0 )) != pBlock)
      {
        ...
        (void)MM_UpdateMsgTracking(pBlock, 1);
  ...
  )
{
  ...
  if(pBlock) {
    ...
    (void)MM_UpdateMsgTracking(pBlock, 0);
...
void *MM_AllocFast(void)
{
  ...
  (void)MM_UpdateMsgTracking(pBlock + 1, 1);
