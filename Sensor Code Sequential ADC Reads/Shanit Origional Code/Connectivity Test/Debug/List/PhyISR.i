...
static phyRxParams_t * mpRxParams = (( void * )( 0 ));
static phyPacket_t * mpRxData = (( void * )( 0 ));
...
{
  mStatusAndControlRegs[0x02] &= 0xF0;
  mStatusAndControlRegs[0x02] &= (uint8_t) ~( (1<<6) ); 
  mStatusAndControlRegs[0x04]   |= (uint8_t)  ( (1<<3) |                                                              (1<<2) |                                                              (1<<1) |                                                              (1<<0));
  mStatusAndControlRegs[0x03]   &= (uint8_t) ~( (7<<0));
  
  
  MC1324xDrv_DirectAccessSPIMultiByteWrite(0x00, mStatusAndControlRegs, 5);
...
{
  mStatusAndControlRegs[0x02] &= 0xF0;
  mStatusAndControlRegs[0x02] |= (uint8_t)  ( (1<<6) |                                                              (1<<2)); 
  mStatusAndControlRegs[0x04]   |= (uint8_t)  ( (1<<3) |                                                              (1<<2) |                                                              (1<<1) |                                                              (1<<0));
  mStatusAndControlRegs[0x03]   &= (uint8_t) ~( (7<<0));
  
  
  mStatusAndControlRegs[0x05]   &= (uint8_t) ~( (1<<6));
  mStatusAndControlRegs[0x07]   &= (uint8_t) ~( (1<<6));
  
  MC1324xDrv_DirectAccessSPIWrite(0x05, mStatusAndControlRegs[0x05]);
  MC1324xDrv_DirectAccessSPIWrite(0x07, mStatusAndControlRegs[0x07]);
...
{
  uint8_t energyLevel;
  energyLevel = MC1324xDrv_DirectAccessSPIRead((uint8_t) 0x0B);
...
)
{
  ...
  MC1324xDrv_DirectAccessSPIMultiByteRead(0x00, mStatusAndControlRegs, 8);
  
  xcvseqCopy = mStatusAndControlRegs[0x03] & (7<<0);
  
   
  if(   ((mStatusAndControlRegs[0x01] & (1<<0)) == (1<<0))
      &&((mStatusAndControlRegs[0x05] & (1<<0)) != (1<<0)) )
  {
    
    MC1324xDrv_DirectAccessSPIMultiByteWrite(0x00, mStatusAndControlRegs, 3);
  ...
  if( (mStatusAndControlRegs[0x00] & (1<<0)) == (1<<0) )
  {
    
    if( (mStatusAndControlRegs[0x00] & (1<<6)) == (1<<6) )
    {
      PhyIsrSeqCleanup();
    ...
    if(  ((mStatusAndControlRegs[0x02] & (1<<2)) == (1<<2))
       &&((mStatusAndControlRegs[0x00] & (1<<2))   != (1<<2)) )
    {
    ...
    switch(xcvseqCopy)
    {
      case gTX_c:
      {
        if(  ((mStatusAndControlRegs[0x01] & (1<<6))        == (1<<6))
           &&((mStatusAndControlRegs[0x03]   & (1<<5)) == (1<<5)) )
        {
      ...
      case gTR_c:
      {
        ...
        {
          if((( void * )( 0 )) != mpRxParams)
          {
            
            mpRxParams->linkQuality = MC1324xDrv_DirectAccessSPIRead((uint8_t) 0x25);
            MC1324xDrv_DirectAccessSPIMultiByteRead( (uint8_t) 0x0F, (uint8_t *) mpRxParams->timeStamp, 3);
          }
          PhyPdDataConfirm();
        }
      }
      ...
      case gRX_c:
      {
        ...
        if((( void * )( 0 )) != mpRxData)
        {
          MC1324xDrv_PB_SPIBurstRead((uint8_t *) (&mpRxData->data[0]), (uint8_t)(mStatusAndControlRegs[0x06] - 2));
          mpRxData->frameLength = (uint8_t)(mStatusAndControlRegs[0x06] - 2);
        }
      ...
      case gCCA_c:
      {
        if( (mStatusAndControlRegs[0x07] & ((3<<0) << (3))) == (gCcaED_c << (3)) )
        {
  ...
  {
    if((mStatusAndControlRegs[0x02] & (1<<1)) == (1<<1))
    {
      
      mStatusAndControlRegs[0x02] &= 0xF0;
      mStatusAndControlRegs[0x02] |= (uint8_t)  ( (1<<5) |                                                                  (1<<1));
      
      MC1324xDrv_DirectAccessSPIWrite(0x02, mStatusAndControlRegs[0x02]);
      
      
      mStatusAndControlRegs[0x05]   &= (uint8_t) ~( (1<<5));
      mStatusAndControlRegs[0x03]   &= (uint8_t) ~( (1<<7));
      

      
      MC1324xDrv_DirectAccessSPIWrite(0x05, mStatusAndControlRegs[0x05]);
      MC1324xDrv_DirectAccessSPIWrite(0x07, mStatusAndControlRegs[0x07]);
      MC1324xDrv_DirectAccessSPIWrite(0x03, mStatusAndControlRegs[0x03]);
    ...
    if((mStatusAndControlRegs[0x02] & (1<<0)) == (1<<0))
    {
      
      mStatusAndControlRegs[0x02] &= 0xF0;
      mStatusAndControlRegs[0x02] |= (uint8_t)  ( (1<<4) |                                                                  (1<<0));
      
      MC1324xDrv_DirectAccessSPIWrite(0x02, mStatusAndControlRegs[0x02]);
      
      
      mStatusAndControlRegs[0x05]   &= (uint8_t) ~( (1<<4));
      
      MC1324xDrv_DirectAccessSPIWrite(0x05, mStatusAndControlRegs[0x05]);

    }
    if((mStatusAndControlRegs[0x02] & (1<<3)) == (1<<3))
    {
      
      mStatusAndControlRegs[0x02] &= 0xF0;
      mStatusAndControlRegs[0x02] |= (uint8_t)  ( (1<<7) |                                                                  (1<<3));
      
      MC1324xDrv_DirectAccessSPIWrite(0x02, mStatusAndControlRegs[0x02]);
      
      
      mStatusAndControlRegs[0x05]   &= (uint8_t) ~( (1<<7));
