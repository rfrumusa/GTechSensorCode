...
void CommUtil_Tx(uint8_t * pData, uint8_t length)
{
            ...
            ((uint32_t)pData < (uint32_t)__region_ROM_end__))
  {
    ...
    while(!Uart1_Transmit(pRam,(index_t)length,CommUtil_TxCallback));
  }

  else
  {
    while(!Uart1_Transmit(pData,(index_t)length,(( void * )( 0 ))));
  }
...
void CommUtil_Print(char* pString, commUtilBlock_t allowToBlock)
{
  ...
  else
  {
            ...
            ((uint32_t)pString < (uint32_t)__region_ROM_end__))
    {
      ...
      (void)Uart1_Transmit((unsigned char const*)pRam,(index_t)i,CommUtil_TxCallback);
    }
    else
    {
      (void)Uart1_Transmit((unsigned char const*)pString,(index_t)i,(( void * )( 0 )));      
    }    
...
void CommUtil_PrintHex(uint8_t *hex, uint8_t len, uint8_t flags)
{
  ...
  while(len)
  {
    ...
    (void)Uart1_Transmit((unsigned char const*)hexString,(index_t)i,(( void * )( 0 )));
  }
...
void CommUtil_PrintDec(uint32_t nr)
{
  ...
  (void)Uart1_Transmit((uint8_t*)&decString[i], 12-i, (( void * )( 0 )));
