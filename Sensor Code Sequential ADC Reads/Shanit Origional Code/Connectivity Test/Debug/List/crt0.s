...
//        "C:\Users\rfrum\OneDrive\2018 Spring Semester\Senior Design\Sensor
//        Code\Shanit Origional Code\Connectivity Test\PLM\Source\Sys
//        Common\crt0.c" -D IAR --preprocess "C:\Users\rfrum\OneDrive\2018
...
//    List file    =  
//        C:\Users\rfrum\OneDrive\2018 Spring Semester\Senior Design\Sensor
//        Code\Shanit Origional Code\Connectivity Test\Debug\List\crt0.s
//
///////////////////////////////////////////////////////////////////////////////
...
// C:\Users\rfrum\OneDrive\2018 Spring Semester\Senior Design\Sensor Code\Shanit Origional Code\Connectivity Test\PLM\Source\Sys Common\crt0.c
//    1 /******************************************************************************
//    2  * Filename: crt0.c
//    3  *
...
//  101   SCB_VTOR = (uint32_t)__vector_table; /* Set the interrupt vector table position */   
        LDR.N    R0,??__low_level_init_0+0x4
        LDR.N    R2,??__low_level_init_0+0x8  ;; 0xe000ed08
        STR      R0,[R2, #+0]
//  102   
//  103   /*
...
//  111                 | SIM_SCGC5_PORTE_MASK );  
        LDR.N    R0,??__low_level_init_0+0xC  ;; 0x40048038
        LDR      R0,[R0, #+0]
        ORRS     R0,R0,#0x3E00
        LDR.N    R2,??__low_level_init_0+0xC  ;; 0x40048038
        STR      R0,[R2, #+0]
//  112   
//  113   /*
...
//  118   *(volatile unsigned short *)gCRT0_WDOG_UnlockAddr_c = gCRT0_WDOG_UnlockSeq1_c;
        MOVW     R0,#+50464
        LDR.N    R2,??__low_level_init_0+0x10  ;; 0x4005200e
        STRH     R0,[R2, #+0]
...
//  120   *(volatile unsigned short *)gCRT0_WDOG_STCTRLH_Addr_c = gCRT0_WDOG_Disabled_Ctrl_c;
        MOVS     R0,#+210
        LDR.N    R2,??__low_level_init_0+0x14  ;; 0x40052000
        STRH     R0,[R2, #+0]
//  121   
//  122 #if STACK_FILL
//  123 
...
//  152   if (PMC_REGSC & PMC_REGSC_ACKISO_MASK)
        LDR.N    R0,??__low_level_init_0+0x18  ;; 0x4007d002
        LDRB     R0,[R0, #+0]
        LSLS     R0,R0,#+28
        BPL.N    ??__low_level_init_1
//  153   {
//  154     PMC_REGSC |= PMC_REGSC_ACKISO_MASK;
        LDR.N    R0,??__low_level_init_0+0x18  ;; 0x4007d002
        LDRB     R0,[R0, #+0]
        ORRS     R0,R0,#0x8
        LDR.N    R2,??__low_level_init_0+0x18  ;; 0x4007d002
        STRB     R0,[R2, #+0]
//  155   }
//  156 #endif
//  157   
