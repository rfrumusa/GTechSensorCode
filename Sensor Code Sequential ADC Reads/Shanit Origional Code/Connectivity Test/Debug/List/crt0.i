...
{ 
  ...
  ((((SCB_MemMapPtr)0xE000E000u))->VTOR) = (uint32_t)__vector_table;     
  ...
  *(volatile unsigned short *)0x40052000 = 0xD2;
  ...
  if (((((PMC_MemMapPtr)0x4007D000u))->REGSC) & 0x8u)
  {
    ((((PMC_MemMapPtr)0x4007D000u))->REGSC) |= 0x8u;
  }
