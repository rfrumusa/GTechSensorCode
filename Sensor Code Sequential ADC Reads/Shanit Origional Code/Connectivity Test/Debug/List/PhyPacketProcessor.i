...
)
{
  ...
  phyCtrl4Reg = MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x07);
...
)
{
  ...
  MC1324xDrv_IndirectAccessSPIMultiByteWrite((uint8_t) 0x03, pPanId, 2);
}
...
)
{
  ...
  MC1324xDrv_IndirectAccessSPIMultiByteWrite((uint8_t) 0x13, pPanId, 2);
}
...
)
{
  ...
  MC1324xDrv_IndirectAccessSPIMultiByteWrite((uint8_t) 0x05, pShortAddr, 2);
}
...
)
{
  ...
  MC1324xDrv_IndirectAccessSPIMultiByteWrite((uint8_t) 0x15, pShortAddr, 2);
}
...
)
{
  ...
  MC1324xDrv_IndirectAccessSPIMultiByteWrite((uint8_t) 0x07, pLongAddr, 8);
}
...
)
{
  ...
  MC1324xDrv_IndirectAccessSPIMultiByteWrite((uint8_t) 0x17, pLongAddr, 8);
}
...
)
{
  ...
  dualPanCtrlReg = MC1324xDrv_IndirectAccessSPIRead( (uint8_t) 0x1F);
  ...
  MC1324xDrv_IndirectAccessSPIWrite( (uint8_t) 0x1F, dualPanCtrlReg);
}
...
{
  uint8_t irqsts2Reg;
  irqsts2Reg = MC1324xDrv_DirectAccessSPIRead((uint8_t) 0x01);
  if(irqsts2Reg & (1<<5))
  {
    return 1;
  }
...
{
  MC1324xDrv_IndirectAccessSPIWrite((uint8_t) 0x22, (uint8_t) ccaThreshold);
}
...
)
{
  ...
  srcAddressCheckSum = (uint16_t ) ( (uint16_t) pPanId[0] | (uint16_t) (pPanId[1] << 8) );
      ...
      srcCtrlReg = (uint8_t) ( (index & (0x0F)) << (4) );

      MC1324xDrv_DirectAccessSPIWrite( (uint8_t) 0x08, srcCtrlReg);

      MC1324xDrv_DirectAccessSPIMultiByteWrite( (uint8_t) 0x09, (uint8_t *) &srcAddressCheckSum, 2);
...
)
{
	uint8_t srcCtrlReg;
	    ...
	    srcCtrlReg = MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x08);

	    srcCtrlReg = (srcCtrlReg >> (4));
...
{
  return (uint8_t)( MC1324xDrv_DirectAccessSPIRead( (uint8_t) 0x03) & (7<<0) );
}
...
void PhyAbort(void)
{
  ...
  phyCtrl1Reg &= (uint8_t) ~((1<<7));
  MC1324xDrv_DirectAccessSPIWrite(0x03, phyCtrl1Reg);
  
  
  time = MC1324xDrv_DirectAccessSPIRead(0x0C);
  while(MC1324xDrv_DirectAccessSPIRead(0x0C) < (uint8_t) (time + 6));
  
  
  if((gIdle_c != PhyPpGetState()) && ((MC1324xDrv_DirectAccessSPIRead(0x24)&0x1F) != 0))
  {
  ...
  phyCtrl2Reg = MC1324xDrv_DirectAccessSPIRead(0x04);
  phyCtrl3Reg = MC1324xDrv_DirectAccessSPIRead(0x05);
  phyCtrl4Reg = MC1324xDrv_DirectAccessSPIRead(0x07);

  
  phyCtrl2Reg |= (uint8_t) ((1<<0));
  MC1324xDrv_DirectAccessSPIWrite(0x04, phyCtrl2Reg);
 
  
  phyCtrl4Reg &= (uint8_t) ~((1<<6));
  phyCtrl3Reg &= (uint8_t) ~((1<<5) | (1<<6));
  MC1324xDrv_DirectAccessSPIWrite(0x05, phyCtrl3Reg);
  
  PhyPassRxParams((( void * )( 0 )));
  PhyPassRxDataPtr((( void * )( 0 )));
  
  
  irqSts1Reg = MC1324xDrv_DirectAccessSPIRead(0x00);
  irqSts2Reg = MC1324xDrv_DirectAccessSPIRead(0x01);
  irqSts3Reg = MC1324xDrv_DirectAccessSPIRead(0x02);
  
  irqSts3Reg |= (uint8_t) ((1<<5) | (1<<6));
  
  MC1324xDrv_DirectAccessSPIWrite(0x00, irqSts1Reg);
  MC1324xDrv_DirectAccessSPIWrite(0x01, irqSts2Reg);
  MC1324xDrv_DirectAccessSPIWrite(0x02, irqSts3Reg);
...
void PhyInit(void)
{
  ...
  u8PartId = MC1324xDrv_IndirectAccessSPIRead(0x00);
  
  if(((0x18) == u8PartId)|| ((0x19) == u8PartId))
  {
      
      MC1324xDrv_DirectAccessSPIWrite(0x3B, 0x0C);  
      MC1324xDrv_DirectAccessSPIWrite(0x23,0x17);          
      
      MC1324xDrv_DirectAccessSPIWrite(0x07,0x4B);       
      MC1324xDrv_DirectAccessSPIWrite(0x08,0x01);        
      
      
      MC1324xDrv_IndirectAccessSPIWrite(0x0F, 0x1F); 
      
       
      MC1324xDrv_IndirectAccessSPIWrite(0x31, 0x02);        
      MC1324xDrv_IndirectAccessSPIWrite(0x91, 0xB3);        
      MC1324xDrv_IndirectAccessSPIWrite(0x92, 0x07);        
      MC1324xDrv_IndirectAccessSPIWrite(0x8A, 0x71);        
      MC1324xDrv_IndirectAccessSPIWrite(0x79, 0x2F);        
      MC1324xDrv_IndirectAccessSPIWrite(0x7A, 0x2F);        
      MC1324xDrv_IndirectAccessSPIWrite(0x7B, 0x24);        
      MC1324xDrv_IndirectAccessSPIWrite(0x7C, 0x24);        
      MC1324xDrv_IndirectAccessSPIWrite(0x7D, 0x24);        
      MC1324xDrv_IndirectAccessSPIWrite(0x7E, 0x24);        
      MC1324xDrv_IndirectAccessSPIWrite(0x7F, 0x32);        
      MC1324xDrv_IndirectAccessSPIWrite(0x80, 0x1D);        
      MC1324xDrv_IndirectAccessSPIWrite(0x81, 0x2D);        
      MC1324xDrv_IndirectAccessSPIWrite(0x82, 0x24);        
      MC1324xDrv_IndirectAccessSPIWrite(0x83, 0x24);        
      MC1324xDrv_IndirectAccessSPIWrite(0x64, 0x28);        
      MC1324xDrv_IndirectAccessSPIWrite(0x52, 0x55);        
      MC1324xDrv_IndirectAccessSPIWrite(0x53, 0x2D);        
      MC1324xDrv_IndirectAccessSPIWrite(0x66, 0x5F);        
      MC1324xDrv_IndirectAccessSPIWrite(0x67, 0x8F);        
      MC1324xDrv_IndirectAccessSPIWrite(0x68, 0x61);        
      MC1324xDrv_IndirectAccessSPIWrite(0x78, 0x03);        
      MC1324xDrv_IndirectAccessSPIWrite(0x22, 0x50);        
      MC1324xDrv_IndirectAccessSPIWrite(0x4D, 0x13);        
      MC1324xDrv_IndirectAccessSPIWrite(0x39, 0x3D);        
      
  }
  else
  {
      if(((0x48) == u8PartId) || ((0x88) == u8PartId) || ((0xC8) == u8PartId))
      {
          
          MC1324xDrv_DirectAccessSPIWrite(0x3B, 0x05);   
          MC1324xDrv_DirectAccessSPIWrite(0x07,0x4B);
          MC1324xDrv_DirectAccessSPIWrite(0x08,0x01); 
          ...
          MC1324xDrv_IndirectAccessSPIWrite(0x31, 0x02); 
          MC1324xDrv_IndirectAccessSPIWrite(0x79, 0x1B); 
          MC1324xDrv_IndirectAccessSPIWrite(0x7A, 0x1B); 
          MC1324xDrv_IndirectAccessSPIWrite(0x7B, 0x20); 
          MC1324xDrv_IndirectAccessSPIWrite(0x7C, 0x20); 
          MC1324xDrv_IndirectAccessSPIWrite(0x7D, 0x20); 
          MC1324xDrv_IndirectAccessSPIWrite(0x7E, 0x20); 
          MC1324xDrv_IndirectAccessSPIWrite(0x82, 0x20); 
          MC1324xDrv_IndirectAccessSPIWrite(0x83, 0x20); 
          MC1324xDrv_IndirectAccessSPIWrite(0x7F, 0x30); 
          MC1324xDrv_IndirectAccessSPIWrite(0x80, 0x1B); 
          MC1324xDrv_IndirectAccessSPIWrite(0x81, 0x2B); 
          MC1324xDrv_IndirectAccessSPIWrite(0x67, 0x11); 
          MC1324xDrv_IndirectAccessSPIWrite(0x64, 0x28); 
          MC1324xDrv_IndirectAccessSPIWrite(0x92, 0x01); 
          MC1324xDrv_IndirectAccessSPIWrite(0x75, 0x00); 
          MC1324xDrv_IndirectAccessSPIWrite(0x52, 0x3C); 
          MC1324xDrv_IndirectAccessSPIWrite(0x53, 0xFF); 
          MC1324xDrv_IndirectAccessSPIWrite(0x66, 0x5F); 
          MC1324xDrv_IndirectAccessSPIWrite(0x23, 0x6D); 
          MC1324xDrv_IndirectAccessSPIWrite(0x24, 0x24); 
          MC1324xDrv_IndirectAccessSPIWrite(0x61, 0x36); 
          
      }
  }
           
      PhyPlmeSetCurrentChannelRequestPAN0(0x0B);        
